...
public class Messages {
	...
	public ChunkedOutput<String> getPrivate(@HeaderParam(Authentifier.PARAM_NAME) final String token) {
	...
	@Produces(MediaType.APPLICATION_JSON)
	public ChunkedOutput<String> addPrivate(final Message message, @HeaderParam(Authentifier.PARAM_NAME) final String token) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (usernames != null) {
    				User user = usernames.size()>0? usernames.get(0):null;
                ...
                aMessage.setContractTitle(null);
                aMessage.setContractID(null);
